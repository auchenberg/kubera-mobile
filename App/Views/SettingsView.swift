...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            // Scrolling only. `checking` mirrors a connection test that is
            // genuinely in flight, so clearing it would leave the screen
            // claiming work had finished while it ran on.
            .scrollsToTopOnTabReset(of: .settings)
            .confirmationDialog(
                "Disconnect Kubera?",
